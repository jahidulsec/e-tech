...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center  p-1 text-muted-foreground w-full border-b",
      className
    )}
    {...props}
  />
